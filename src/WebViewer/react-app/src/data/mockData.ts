...
export const projectTree: TreeNode[] = [
  {
    id: 'asm-1',
    label: 'Structural Assembly v4.2',
    type: 'assembly',
    status: 'active',
    expanded: true,
    children: [
  ...
  },
  {
    ...
    type: 'group',
    children: [
      { id: 'tw-1', label: 'System Unit Alpha', type: 'twin', status: 'active' },
      { id: 'tw-2', label: 'System Unit Beta', type: 'twin', status: 'warning' },
    ]
  },
  {
    id: 'ai-group',
...
export const machineFleet: MachineUnit[] = [
  {
    id: 'm1', name: 'System Alpha-01', type: 'Primary System', status: 'online',
  ...
  {
    id: 'm2', name: 'System Alpha-02', type: 'Primary System', status: 'online',
  ...
  {
    id: 'm3', name: 'System Beta-01', type: 'Secondary System', status: 'degraded',
  ...
  {
    id: 'm4', name: 'System Beta-02', type: 'Secondary System', status: 'maintenance',
...
export const timelineEvents: TimelineEvent[] = [
  ...
  { id: 'ev6', timestamp: '14:18:55', type: 'maintenance', title: 'System Beta-02 entered maintenance mode', severity: 'warning' },
