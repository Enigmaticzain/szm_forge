...
const notifications: Notification[] = [
  ...
  { id: 'n8', type: 'critical', title: 'Turbine Beta-01 Efficiency Drop', message: 'Operating efficiency has fallen below 90% threshold.', timestamp: '45 min ago', read: true, source: 'Fleet Monitor' },
];
